...
const getCustomTitle = (permalink: string, locale: string): string | null => {
  const rules = {
    en: [
      ...
      { pattern: /^\/rdk_doc\/en\/rdk_s\/Advanced_development$/, title: '4. Advanced Development' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/hardware_development$/, title: '4.1 Hardware Development Guide' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/linux_development$/, title: '4.2. Linux Development Guide' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/driver_development_s100$/, title: '4.2.4 RDK S100 Driver Development Guide' },
      ...
      { pattern: /^\/rdk_doc\/en\/rdk_s\/hardware_unit_test$/, title: '4.2.5 Hardware Unit Testing' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/03_multimedia_development$/, title: '4.3 Multimedia Development Guide' },
      { pattern: /\/rdk_doc\/en\/rdk_s\/category\/731\-s100/, title: '4.3.1 S100 Multimedia Development Guide' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/02_multimedia_application$/, title: '4.3.2 Multimedia Application Development' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/04_toolchain_development$/, title: '4.4 Algorithm Toolchain Development Guide' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/05_MCU_development$/, title: '4.5 MCU Development Guide' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/01_S100$/, title: '4.5.1 S100 MCU Development Guide' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/04_Advanced_development\/05_mcu_development\/01_S100\/12_mcu_port$/, title: 'PORT Module Guide' },
      { pattern: /^\/rdk_doc\/en\/rdk_s\/Appendix$/, title: '6. Appendix' },
      ...
      { pattern: /^\/rdk_doc\/en\/Advanced_development$/, title: '4. Advanced Development' },
      { pattern: /^\/rdk_doc\/en\/hardware_development$/, title: '4.1 Hardware Development Guide' },

      { pattern: /^\/rdk_doc\/en\/linux_development$/, title: '4.2. Linux Development Guide' },
      { pattern: /^\/rdk_doc\/en\/Advanced_development\/linux_development\/driver_development_x5\/memory$/, title: 'Linux System Memory Usage' },
      { pattern: /^\/rdk_doc\/en\/Advanced_development\/linux_development\/hardware_unit_test$/, title: '4.4 Hardware Unit Testing' },
      { pattern: /^\/rdk_doc\/en\/03_multimedia_development$/, title: '4.3 RDK X3 Multimedia Development Guide' },
      { pattern: /^\/rdk_doc\/en\/04_toolchain_development$/, title: '4.4 Algorithm Toolchain Development Guide' },
      { pattern: /^\/rdk_doc\/en\/FAQ$/, title: '5. FAQs' },
