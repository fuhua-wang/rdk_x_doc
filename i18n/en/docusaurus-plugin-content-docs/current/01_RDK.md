...
For related download resources, please refer to: [Download Resources Summary](./02_02_02_Quick_start/07_01_02_02_Quick_start/07_download.md)
...
- **System Backup:** New rdk-backup tool for one-click system backup and image generation. [rdk-backup introduction](./08_08_Appendix/rdk-command-manual/cmd_rdk-backup).
