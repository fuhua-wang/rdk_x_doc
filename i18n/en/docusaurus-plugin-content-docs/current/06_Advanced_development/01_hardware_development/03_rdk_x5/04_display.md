...
```
You can also select the output method through `raspi-config`. For more details, refer to the [Display Choose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section.
...
![screenshot-20241014-161007](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-161007.png)
...
mv /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf.disable /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf
```
You can also choose the output method via `srpi-config`. Please refer to the [Display Chose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section.
...
![screenshot-20241014-173409](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-173409.png)
...
mv /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf.disable /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf
```
You can also choose the output method through `srpi-config`. Please refer to the [Display Choose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section.
...
![screenshot-20241014-173446](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-173446.png)
...
![screenshot-20241014-144324](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-144324.png)
...
mv /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf.disable /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf
```
You can also choose the output mode through `raspi-config`. Refer to the [Display Chose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section for details.
...
![screenshot-20241014-144429](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-144429.png)
...
![screenshot-20241014-154448](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-154448.png)
![screenshot-20241014-155331](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-155331.png)
...
mv /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf.disable /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf
```
You can also choose the output mode through `raspi-config`. For more details, refer to the [Display Choose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section.
...
![screenshot-20241014-155439](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-155439.png)
...
![screenshot-20241014-165628](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-165628.png)
...
mv /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf.disable /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf
```
You can also select the output method through `srpi-config`. For more details, refer to the [Display Choose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section.
...
![screenshot-20241014-165707](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-165707.png)
...
![screenshot-20241014-151754](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-151754.png)
...
mv /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf.disable /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf
```
You can also choose the output mode through `raspi-config`. Please refer to the [Display Choose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section.
...
![screenshot-20241014-152537](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-152537.png)
...
![screenshot-20241014-174402](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-174402.png)
...
mv /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf.disable /etc/X11/xorg.conf.d/xorg_hdmi_ignore.conf
```
You can also select the output mode using `raspi-config`. For more details, refer to the [Display Chose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section.
...
![screenshot-20241014-174925](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/display/screenshot-20241014-174925.png)
