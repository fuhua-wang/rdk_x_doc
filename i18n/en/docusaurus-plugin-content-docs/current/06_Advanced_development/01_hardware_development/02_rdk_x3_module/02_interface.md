...
The purchase information for the above Camera modules can be found in the [purchase link](./01_02_02_Quick_start/08_accessory.md).
...
2. Use the official burning tool `hbupdate` to update the core board's startup firmware. For specific methods, please refer to [Image Burning](../../../02_02_02_Quick_start/02_install_os.md).
