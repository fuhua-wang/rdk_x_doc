...
```
You can also choose the display output method using `raspi-config`. For details, refer to the [Display Choose DSI or HDMI](../../../03_03_System_configuration/srpi-config#display-options) section.
...
![image-20220518111319607](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/02_linux_development/03_driver_development_x5/screenshot-20241125-162524.png)
