...
![model_conversion_flowchart](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/model_conversion_flowchart.png)
...
![model_reshape](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/model_reshape.png)
...
![model_reshape](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/model_reshape_ONNX.png)
...
To avoid excessive code length, the implementation code of various simple transformers is not included. For specific usage, please refer to the chapter "Transformer Usage" in the [**Toolchain**](../../../07_07_07_FAQ/05_toolchain.md#transposetransformer) section.
...
- For "RDK X3 yaml configuration file", fill in the template file [**RDK X3 Caffe model quantization yaml template**](../../../07_07_07_FAQ/05_toolchain.md#rdk_x3_caffe_yaml_template) or [**RDK X3 ONNX model quantization yaml template**](../../../07_07_07_FAQ/05_toolchain.md#rdk_x3_onnx_yaml_template) directly.

- For **RDK X5** YAML configuration files, use the [**RDK X5 Caffe model quantization yaml template**](../../../07_07_07_FAQ/05_toolchain.md#rdk_x5_caffe_yaml_template) and [**RDK X5 ONNX model quantization yaml template**](../../../07_07_07_FAQ/05_toolchain.md#rdk_x5_onnx_yaml_template) directly.

- If the hb_mapper makertbin step terminates abnormally or shows an error message, it means that the model conversion has failed. Please check the error message and modification suggestions in the terminal printout or in the ``hb_mapper_makertbin.log`` log file generated in the current path. You can find the solution for the error in the [**Model Quantization Errors and Solutions**](../../../07_07_07_FAQ/05_toolchain.md#model_convert_errors_and_solutions) section. If the problem cannot be solved after these steps, please contact the D-Robotics technical support team or submit your question in the [**D-Robotics Official Technical Community**](https://developer.d-robotics.cc/). We will provide support within 24 hours.
...
![input_data_process](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/input_data_process.png)
...
![model_optimization](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/model_optimization.png)
...
![hb_mapper_perf_2](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/hb_mapper_perf_2.png)
...
Please translate the following content into English, maintaining the original format and content: ![layer_details](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/layer_details.png)
...
- CPU operator is at the beginning or end of the model
  ...
  - For models like the one in the picture below that are not connected to input and output nodes, the hb_model_modifier tool needs to be used to determine if the connected nodes support deletion. The nodes can then be deleted one by one in order.
    ...
    ![nodes_connected](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/nodes_connected.png)
...
![accuracy_problem](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/accuracy_problem.png)
...
![accuracy_debug_process](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/accuracy_debug_process.png)
...
![debug_node](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/debug_node.png)
...
![average_mode_false_1](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/average_mode_false_1.png)

When `average_mode = True`:

![average_mode_true_1](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/average_mode_true_1.png)
...
![new_average_mode_false_1](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/new_average_mode_false_1.png)

When average_mode=True:

![new_average_mode_true_1](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/new_average_mode_true_1.png)
...
![average_mode_false_2](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/average_mode_false_2.png)

When average_mode = True:

![average_mode_true_2](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/average_mode_true_2.png)
...
![new_average_mode_false_2](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/new_average_mode_false_2.png)When `average_mode = True`:

![new_average_mode_true_2](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/new_average_mode_true_2.png)
...
![weight_activation_quantized](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/weight_activation_quantized.png)
...
![node_output](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/node_output.png)

weight：

![weight](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/weight.png)

activation：

![activation](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/activation.png)
...
![weight_calibration_node](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/weight_calibration_node.png)

Activation calibration node:

![activate_calibration_node](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/activate_calibration_node.png)

The output result is shown in the following figure:

![box_plot](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/box_plot.png)
...
![Runall Workflow](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/runall.png)
...
Based on previous optimization experience, this strategy covers most scenarios. If issues persist, follow the [**Precision Optimization Checklist**](../../../07_07_07_FAQ/05_toolchain.md#checklist) to gather detailed model configuration information, ensure all troubleshooting steps have been completed, and report the filled checklist, the original float model file, and relevant configuration files to the D-Robotics support team or the [**D-Robotics Official Technical Community**](https://developer.d-robotics.cc/) for further assistance.
...
![hb_model_modifier](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/hb_model_modifier.png)
