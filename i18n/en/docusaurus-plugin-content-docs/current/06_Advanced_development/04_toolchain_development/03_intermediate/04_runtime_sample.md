...
1. After receiving the development board, please update the development board image to the latest version. For the upgrade method, please refer to the [**System Update**](../../../02_02_02_Quick_start/02_install_os.md#flash_system) chapter.
...
1. After receiving the development board, please update the board image to the latest version. Refer to the chapter [**Installation**](../..../../../02_02_02_Quick_start/02_install_os.md#flash_system) for the upgrade method.
...
After mounting the data, please log in to the development board. For the login method, please read the [**development board login**](../../../02_02_02_Quick_start/04_02_02_02_Quick_start/04_remote_login.md) section. After successful login, execute the `accuracy.sh` script in the `fcos_efficientnetb0/` directory as shown below:
