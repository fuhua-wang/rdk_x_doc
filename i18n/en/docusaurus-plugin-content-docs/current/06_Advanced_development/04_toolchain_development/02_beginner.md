...
**Note**: Before deploying the model, make sure to complete the environment setup on the development board according to the steps in the [**System Installation**](..../../../02_02_02_Quick_start/02_install_os.md) section. 
...
![yolov5s-result](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/image/beginner/yolov5s-result.png)
