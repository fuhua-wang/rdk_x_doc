...
![RDK_X5_interface](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/hardware_interface/RDK_X5_interface.jpg)
...
![img-20250416-161040](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/hardware_interface/img-20250416-161040.png)
...
![img-20250418-111059](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/hardware_interface/img-20250418-111059-en.png)
...
The USB Type A ports (Interface 7) support USB-to-serial adapters, which will be automatically detected and create device nodes such as `/dev/ttyUSB*` or `/dev/ttyACM*` (where the asterisk represents a number starting from 0). Refer to the [40-pin UART Usage](../../04_04_04_Basic_Application/03_40pin_user_guide/uart.md#40pin_uart_usage) section for details.
...
The RDK X5 provides a CAN FD interface for CAN and CAN FD communication. Refer to the [CAN Usage](../../05_06_06_Advanced_development/01_hardware_development/rdk_x5/can.md) section for details.
...
This setup supports both CAN and CAN FD communication. For detailed information, please refer to the relevant documentation. [CAN使用](../../05_06_06_Advanced_development/01_hardware_development/rdk_x5/can.md)
