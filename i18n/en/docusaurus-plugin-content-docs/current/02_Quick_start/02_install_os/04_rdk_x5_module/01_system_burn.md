...
1. Insert the SD card, connect USB Type-C to the PC, **hold Sleep**, power on, wait **5 s** for flashing mode.
    ...
    <img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x5_module/os_insatll_hardware_connection.png" 
          style={{ width: '100%', height: 'auto', align:'center'}}
    />
