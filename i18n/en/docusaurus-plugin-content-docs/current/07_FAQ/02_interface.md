...
3.  **Serial Terminal Software Settings:**
    ...
    * **COM Port:** Make sure you select the correct port as recognized by your PC after connecting the USB-to-serial module.
    ![Serial terminal configuration example](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/interface/image-20221124200013163.png)
...
5.  **Refer to Official Docs:** For detailed steps and troubleshooting, see the "[Network Configuration](../03_03_03_System_configuration/01_network_blueteeth.md)" section (replace with the actual valid doc path).
...
* **Error: `Connection timed out`:**
    ...
    * **Reference:** See the [SSH Login](../02_02_02_Quick_start/04_02_02_02_Quick_start/04_remote_login.md) section (replace with the actual valid doc path).
...
* **Error: `Authentication failed` or `Permission denied, please try again.`:**
    ...
    * **Troubleshooting:**
    ...
    ![SSH authentication failure example](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/interface/image-20221124201544978.png)
...
1.  **Incorrect camera connection:**
    ...
    * **Reference docs:** Check your board's hardware manual or quick start guide for the "[MIPI Camera](../02_02_02_Quick_start/01_hardware_introduction/01_rdk_x3.md)" section (replace with the actual valid doc path) for connection details.
...
* **How to check:**
    1.  **Official docs:** The most accurate info is in your board's User Manual or Hardware Specification, in the "[HDMI Interface](../02_02_02_Quick_start/01_hardware_introduction/01_rdk_x3.md)" or display subsystem section (replace with the actual valid doc path).
