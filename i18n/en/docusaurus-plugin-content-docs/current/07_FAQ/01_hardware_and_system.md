...
Many issues can be resolved through system updates. For related download resources, please refer to: [Download Resources Summary](../02_02_02_Quick_start/07_01_02_02_Quick_start/07_download.md)

:::

For certified accessories and purchase links, please refer to the [Certified Accessories List](https://developer.d-robotics.cc/rdk_doc/06_06_Advanced_development/hardware_development/rdk_x3/accessory).
...
Connection diagram:
![RDK X3 Serial Connection Diagram](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/hardware_and_system/connect.png)
...
![F37 Camera to RDK X3 Diagram](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/hardware_and_system/image-X3-PI-Camera.png)
...
2.  **Run the MIPI camera sample (for RDK X3):**
    ...
    ![MIPI Camera AI Output Example](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/hardware_and_system/image-20220511181747071.png)
...
* **Insufficient or unstable power:**
    * **Symptoms:** System reboots during U-Boot or early kernel boot without clear error logs; green LED abnormal (e.g., not blinking or always on); HDMI black screen.
        ![U-Boot reboot due to power issue](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/system/image-20230914173433676.png)
        ![Kernel reboot due to power issue](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/system/image-20230914174123619.png)
    * **Troubleshooting:**
        ...
        * Refer to the [official accessory list](https://developer.d-robotics.cc/rdk_doc/06_06_Advanced_development/hardware_development/rdk_x3/accessory) for recommended adapters.
...
* **Boot media issues (Micro SD/eMMC):**
    * **Symptoms:** Serial log shows filesystem mount failure, missing partitions, MMC/SD init errors or timeouts.
        ![SD card image format error](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/system/image-20221124194527634.png)
        ![SD card physical/contact error 1](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/system/image-20221124194636213.png)
        ![SD card physical/contact error 2](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/system/image-20221124194721750.png)
    * **Troubleshooting:**
...
1.  **Via `/etc/rc.local` (traditional):**
    ...
    exit 0
    ```
    Reference: [RDK Docs - rc.local Autostart](https://developer.d-robotics.cc/rdk_doc/03_03_System_configuration/self_start)
...
See related 07_07_FAQ entries for distinguishing RDK X3 and Sunrise X3 Pi.
