...
- **20250610**  
  ...
  - Supports [real-time kernel switching](../06_06_Advanced_development/linux_development/realtime_kernel#x5系列板卡)  
...
- **System Backup**: Brand new `rdk-backup` tool for one-click system backup and easy image generation. See [rdk-backup introduction](../08_08_Appendix/rdk-command-manual/cmd_rdk-backup)
