...
After the program is executed, the monitor will display the camera feed and the results of the object detection algorithm (object type, confidence level) in real-time, as shown below:
  ![image-20220612110739490](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/01_Image/image/usb_camera/image-20220612110739490.png)

:::tip

For detailed code implementation instructions, please refer to the [Inference Based on USB Camera](../../03_pydev_demo_sample/RDK_X3/02_04_04_Basic_Application/03_pydev_demo_sample/RDK_X5/08_usb_camera_sample.md) section.
