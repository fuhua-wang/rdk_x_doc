...
- Connect the MIPI camera module to the MIPI CSI interface of the development board. For specific connection methods, refer to - [Hardware Introduction - MIPI Interface](https://developer.d-robotics.cc/rdk_doc/en/02_02_Quick_start/hardware_introduction/rdk_x3#mipi_port)  
...
![image-20220503221020331](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/08_07_07_FAQ/image/hardware_and_system/image-20220511181747071.png)