...
For the size limitations of the VPS on the `X3` chip, please refer to [Video Processing - Feature Description](https://developer.d-robotics.cc/rdk_doc/en/06_06_Advanced_development/multimedia_development/video_processing).  
