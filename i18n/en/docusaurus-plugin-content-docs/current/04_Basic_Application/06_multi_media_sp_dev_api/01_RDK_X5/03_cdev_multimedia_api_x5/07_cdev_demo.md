...
![image-vio_to_display](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/04_multi_media/image/cdev_demo/image-vio_to_display.jpg)

- **Environment Setup:**
   - With the development board powered off, connect the `MIPI` camera to the development board. Refer to the [MIPI camera connection tutorial](../../../../02_02_02_Quick_start/01_hardware_introduction/01_rdk_x3.md#mipi_port) for the connection method.
...
![image-capture](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/04_multi_media/image/cdev_demo/image-capture.jpg)

 - **Preparation:**
   - Connect the `MIPI` camera to the development board while the development board is powered off. For the connection method, see [MIPI Camera Connection Guide](https://developer.d-robotics.cc/rdk_doc/en/02_02_Quick_start/hardware_introduction/rdk_x3#mipi_port).
...
![Image Capture Workflow](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/04_multi_media/image/cdev_demo/image-capture.jpg)

---

 - **Environment Setup**

1. Power off the development board, connect the `MIPI` camera to the board. Refer to [Hardware Introduction - MIPI Interface](https://developer.d-robotics.cc/rdk_doc/en/02_02_Quick_start/hardware_introduction/rdk_x5#mipi_port) for detailed connection instructions.
...
- **Preparation:**
  - With the development board powered off, connect the `MIPI` camera to the board. Refer to the [MIPI Camera Connection Tutorial](https://developer.d-robotics.cc/rdk_doc/02_02_Quick_start/hardware_introduction/rdk_x5#mipi_port) for the connection method.
...
![image-vio_to_encoder](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/04_multi_media/image/cdev_demo/image-vio_to_encoder.jpg)

- **Preparation:**
  - With the development board powered off, connect the MIPI camera to the development board. Refer to the [MIPI camera connection tutorial](https://developer.d-robotics.cc/rdk_doc/en/02_02_Quick_start/hardware_introduction/rdk_x3#mipi_port) for the connection method.
...
![VIO to Encoder Workflow](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/04_multi_media/image/cdev_demo/image-vio_to_encoder.jpg)

---

 - **Environment Setup**

1. Power off the development board and connect the `MIPI` camera. Refer to [Hardware Introduction - MIPI Interface](https://developer.d-robotics.cc/rdk_doc/en/02_02_Quick_start/hardware_introduction/rdk_x5#mipi_port) for connection details.  
2. Connect the development board to a monitor using an HDMI cable.  
3. Power on the board and log in via the command line.
...
![image-decoder_to_display](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/04_multi_media/image/cdev_demo/image-decoder_to_display.jpg)
...
![rtsp2display](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/04_multi_media/image/cdev_demo/image-rtsp_to_display.jpg)
...
- **Environment Setup:**
   - With the development board powered off, connect the `MIPI` camera to the development board following the instructions in the [MIPI Camera Connection Tutorial](https://developer.d-robotics.cc/rdk_doc/en/02_02_Quick_start/hardware_introduction/rdk_x3#mipi_port).
  - Connect the development board to the monitor using an HDMI cable.
  - Power on the development board and log in via the command line.
