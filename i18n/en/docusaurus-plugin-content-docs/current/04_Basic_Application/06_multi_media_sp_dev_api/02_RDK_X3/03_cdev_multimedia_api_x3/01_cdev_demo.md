...
![image-capture](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/04_multi_media/image/cdev_demo/image-capture.jpg)
 ...
 - **Preparation:**
   - Connect the `MIPI` camera to the development board while the development board is powered off. For the connection method, see [MIPI Camera Connection Guide](../../../../02_02_02_Quick_start/01_hardware_introduction/01_rdk_x3.md#mipi_port).
...
1. Power off the development board, connect the `MIPI` camera to the board. Refer to [Hardware Introduction - MIPI Interface](../../../../02_02_02_Quick_start/01_hardware_introduction/02_rdk_x5.md#mipi_port) for detailed connection instructions.
...
- **Preparation:**
  - With the development board powered off, connect the `MIPI` camera to the board. Refer to the [MIPI Camera Connection Tutorial](../../../../02_02_02_Quick_start/01_hardware_introduction/01_rdk_x3.md#mipi_port) for the connection method.
...
1. Power off the development board and connect the `MIPI` camera. Refer to [Hardware Introduction - MIPI Interface](../../../../02_02_02_Quick_start/01_hardware_introduction/02_rdk_x5.md#mipi_port) for connection details.  
2. Connect the development board to a monitor using an HDMI cable.  
3. Power on the board and log in via the command line.
...
- **Environment Setup:**
   - With the development board powered off, connect the `MIPI` camera to the development board following the instructions in the [MIPI Camera Connection Tutorial](../../../../02_02_02_Quick_start/01_hardware_introduction/01_rdk_x3.md#mipi_port).
  - Connect the development board to the monitor using an HDMI cable.
  - Power on the development board and log in via the command line.
