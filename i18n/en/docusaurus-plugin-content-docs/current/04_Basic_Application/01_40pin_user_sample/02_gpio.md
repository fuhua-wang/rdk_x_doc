...
### Install VS Code APP Locally
 ...
 1. Click the application space icon to view more applications.
     ...
     ![Application space interface](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/rdk_studio/rdk_studio_left_menu_device_manage_hr_add_device_application_space_download.png)
