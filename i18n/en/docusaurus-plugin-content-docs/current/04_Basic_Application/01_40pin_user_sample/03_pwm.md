...
4. Click `Open Folder`, then enter the path where the code program is located: `/app/`, and click `OK` to confirm.
    ...
    ![VS Code Open Folder Interface](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/rdk_studio/open_app_path_ok.png)
...
5. Enter the VS Code APP interface, click the list icon on the left navigation bar, select `Terminal` -> `New Terminal` to create a new terminal.
    ...
    ![VS Code New Terminal Interface](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/rdk_studio/vscode_open_terminal.png)
