...
# Algorithm toolchain · Getting started

*[This English-only onboarding page supplements [§ 7.4.1 Introduction](./overview.md). For the numbered subsection hierarchy in section 7.4, refer to intermediate and advanced guides below.]*
