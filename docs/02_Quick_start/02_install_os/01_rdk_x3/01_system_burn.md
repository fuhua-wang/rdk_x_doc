...
- RDK X3 开发板需要使用支持 5V/3A 的电源适配器为开发板供电，推荐使用[基础配件清单](../../../06_06_06_Advanced_development/01_hardware_development/01_rdk_x3/02_01_02_02_Quick_start/08_accessory.md)中推荐的电源适配器型号。
...
3. 点击 “选择” 按钮，选择解压出来的 `rdk-x3-ubuntu22-preinstalled-desktop-3.0.3-arm64.img` 文件作为烧录镜像。
    ...
    <img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x3/rufus_select_image.png" 
          style={{ width: '50%', height: 'auto', align:'center'}}
    />
...
3. 其他参数保持默认，点击 “开始” 按钮，等待烧录完成。
    ...
    <img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x3/rufus_success.png" 
          style={{ width: '50%', height: 'auto', align:'center'}}
    />
