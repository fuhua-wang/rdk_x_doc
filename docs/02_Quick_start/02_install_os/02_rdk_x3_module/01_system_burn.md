...
- RDK X3 Module 通过载板上的 DC 接口供电，推荐使用[配件清单](../../../06_06_06_Advanced_development/01_hardware_development/02_rdk_x3_module/05_01_02_02_Quick_start/08_accessory.md)中推荐的 12V/2A 适配器。
...
<img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x5/rufus_install.png" 
          style={{ width: '100%', height: 'auto', align:'center'}}
/>
...
2. 给设备上电，观察电脑设备管理器端口状态，如出现 `USB download gadget` 未知设备时，需要更新设备驱动。
    ...
    <img
      src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x3_module/usb_download_gadget.png"
      style={{ width: '100%', height: 'auto', align: 'center' }}
    />
...
2. 进入解压后的目录，以管理员身份运行 `5-runasadmin_register-CA-cer.cmd`，完成驱动程序的注册。
    ...
    <img
      src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x3_module/usb_driver_administrator.png"
      style={{ width: '100%', height: 'auto', align: 'center' }}
    />
...
4. 驱动安装完成后，设备管理器会显示 fastboot 设备 `Android Device`。
    ...
    <img
      src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x3_module/android_device.png"
      style={{ width: '100%', height: 'auto', align: 'center' }}
    />
...
5. PC 识别到标准 U 盘即 RDK X3 Module 的 eMMC 分区。
    ...
    <img
      src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x3_module/portable_device.png"
      style={{ width: '100%', height: 'auto', align: 'center' }}
    />
...
<img
      src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x3/studio_select_storage_refresh.png"
      style={{ width: '100%', height: 'auto', align: 'center' }}
    />
...
![imagex3md-ums4](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/02_rdk_x3_module/image/rdk_x3_module/x3md-ums4.png)
