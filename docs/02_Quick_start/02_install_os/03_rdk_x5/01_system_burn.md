...
- 更多供电方式参见 [PoE 供电使用](../../../06_06_06_Advanced_development/01_hardware_development/03_rdk_x5/05_POE.md)。
...
1. SD 卡插入开发板，USB Type-C 接到 PC 端，长按 Sleep 按键（位于耳机接口旁），开发板上电，等待 5s，开发板进入烧录模式。
    ...
    <img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x5/sleep_key.png" 
          style={{ width: '100%', height: 'auto', align:'center'}}
    />
...
2. 打开 Rufus 工具，在 “设备” 下拉框中选择对应的 Micro SD 存储卡作为目标设备。
    ...
    <img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x5/rufus_select_device.png" 
...
3. 点击 “选择” 按钮，选择解压出来的 `rdk-x5-ubuntu22-preinstalled-desktop-3.3.3-arm64.img` 文件作为烧录镜像。
    ...
    <img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x5/rufus_select_image.png" 
          style={{ width: '50%', height: 'auto', align:'center'}}
    />
...
4. 其他参数保持默认，点击 “开始” 按钮，等待烧录完成。
    ...
    <img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/install_os/install_os_260408/zh/x5/rufus_start.png" 
          style={{ width: '50%', height: 'auto', align:'center'}}
    />
