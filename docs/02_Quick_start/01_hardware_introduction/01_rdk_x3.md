...
![debug_uart_x3](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/hardware_interface/debug_uart_x3.jpg)
...
开发板USB Type A接口(接口5和6)，支持USB串口转接板功能，可自动检测USB串口转接板接入并创建设备节点`/dev/ttyUSB*` 或者 `/dev/ttyACM*`（星号代表0开始的数字）。用户可参考 [使用串口](../../04_04_04_Basic_Application/01_40pin_user_sample/04_uart.md#314-串口应用) 章节对串口进行使用。
...
上述Camera模组的购买方式可参考[购买链接](../../06_06_06_Advanced_development/01_hardware_development/01_rdk_x3/02_01_02_02_Quick_start/08_accessory.md)。
...
![image-20220501181722851](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/02_02_02_Quick_start/image/hardware_interface/rdkx3_40pin_cn.png)
...
40PIN各功能的使用方法请查看 [40PIN 功能使用](../../04_04_04_Basic_Application/01_40pin_user_sample/01_40pin_define.md) 章节。
...
![image-40pin-header](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/02_rdk_x3_module/image/rdk_x3_module/image-40pin-header.png)
