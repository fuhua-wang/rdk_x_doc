...
<table className="no-wrap-table">
  ...
  <tbody>
    ...
    <tr>
      <td>🔬 **OpenExplore**</td>
      <td>[RDK X5 OpenExplore](../06_06_06_Advanced_development/04_toolchain_development/02_intermediate/01_environment_config.md#rdk-x5)</td>
      <td>[RDK X3 OpenExplore](../06_06_06_Advanced_development/04_toolchain_development/02_intermediate/01_environment_config.md#rdk-x3)</td>
