...
- **20250610**  
  - 更新 ROS 仓库 GPG 签名密钥  
  - 支持[实时内核切换](../06_06_Advanced_development/linux_development/realtime_kernel#x5系列板卡)  
...
- **系统备份**：全新 `rdk-backup` 工具，一键备份当前系统，轻松生成可烧录镜像。详见 [rdk-backup介绍](../08_08_Appendix/rdk-command-manual/cmd_rdk-backup)
