...
![qat](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/03_expert/qat.svg)
...
3. 以下支持的算子默认为不进行算子融合，对于可进行融合的算子（如 (conv,bn),relu)），参考[**算子融合**](04_advanced_content.md#op_fusion)章节。
