...
:::tip 小技巧
  ...
  horizon_runtime_sample 示例包获取请参考 [交付物说明](01_environment_config.md)。
:::
...
1. 拿到开发板后，请将开发版镜像更新到最新版本，升级方法请参考[**系统更新**](../../../02_02_02_Quick_start/02_install_os/01_rdk_x3.md) 章节内容。

2. 确保本地开发机和开发板可以远程连接。

##### 编译

编译需要当前环境安装好交叉编译工具： ``aarch64-linux-gnu-g++`` ， ``aarch64-linux-gnu-gcc``。 请使用D-Robotics 提供的开发机Docker镜像，直接进行编译使用。开发机Docker环境的获取及使用方法，请阅读[**环境安装**](01_environment_config.md) 章节内容；
...
![model_accuracy](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/model_accuracy.png)

:::caution 注意

  1. 表格中的数据均为在D-Robotics RDK X3开发板的实测结果，测试模型均来自于[horizon_model_convert_sample](01_environment_config.md) 模型示例包；
...
1. 拿到开发板后，请将开发版镜像更新到最新版本，升级方法请参考[**安装系统**](../../../02_02_02_Quick_start/02_install_os/01_rdk_x3.md) 章节内容。

2. 确保本地开发机和开发板可以远程连接。

##### 编译环境准备

编译需要当前环境安装好交叉编译工具 ``gcc-ubuntu-9.3.0-2020.03-x86_64-aarch64-linux-gnu``。请使用D-Robotics 提供的开发机Docker镜像，直接进行编译使用。开发机Docker环境的获取及使用方法，请阅读[**环境安装**](01_environment_config.md) 章节内容；
...
挂载完数据后，请登录开发板，开发板登录方法，请阅读[**开发板登录**](../../../02_02_02_Quick_start/04_02_02_02_Quick_start/04_remote_login.md) 章节内容，登录成功后，执行 ``fcos_efficientnetb0/`` 目录下的accuracy.sh脚本，如下所示：
...
![hrt_model_exec_help](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/hrt_model_exec_help.png)
...
```
![model_info](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/model_info.png)
...
```
![infer](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/infer.png)
...
![enable_cls_post_process](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/enable_cls_post_process.png)
...
```
![perf](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/perf.png)
...
![hrt_bin_dump_help](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/hrt_bin_dump_help.png)
...
![run_log](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/run_log.png)

在路径 **outputs/** 文件夹下可以查看输出，参见以下截图：

![output](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/output.png)
...
1. 拿到开发板后，请将开发版镜像更新到最新版本，升级方法请参考[**系统更新**](../../../02_02_02_Quick_start/02_install_os/03_rdk_x5.md) 章节内容。

2. 确保本地开发机和开发板可以远程连接。

##### 编译

编译需要当前环境安装好交叉编译工具： ``arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu``。 请使用X5算法工具链提供的开发机Docker镜像，直接进行编译使用。开发机Docker环境的获取及使用方法，请阅读[**环境安装**](01_environment_config.md) 章节内容；
...
1. 拿到开发板后，请将开发版镜像更新到最新版本，升级方法请参考[**安装系统**](../../../02_02_02_Quick_start/02_install_os/03_rdk_x5.md) 章节内容。

2. 确保本地开发机和开发板可以远程连接。

##### 编译环境准备

编译需要当前环境安装好交叉编译工具 ``arm-gnu-toolchain-11.3.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-gcc``。请使用X5算法工具链提供的开发机Docker镜像，直接进行编译使用。开发机Docker环境的获取及使用方法，请阅读[**环境安装**](01_environment_config.md) 章节内容；
...
![classification](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/classification.JPEG)

- **2d检测**

![detection2d](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/detection2d.jpg)

- **3d检测**

![detection3d](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/detection3d.png)

- **分割**

![seg](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/seg.png)

- **关键点**

![keypoint](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/keypoint.jpg)

- **车道线**

![land_pred](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/land_pred.png)

- **光流**

![opticalflow](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/opticalflow.png)

- **雷达**

![lidar](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/lidar.png)

- **雷达多任务**

![lidar_det](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/lidar_det.png)

![lidar_seg](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/lidar_seg.png)

- **bev**

![bev_cam_front_left](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/bev_cam_front_left.png)

![bev_cam_front](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/bev_cam_front.png)

![bev_cam_front_right](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/bev_cam_front_right.png)

![bev_cam_back_left](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/bev_cam_back_left.png)

![bev_cam_back](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/bev_cam_back.png)

![bev_cam_back_right](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/bev_cam_back_right.png)

![bev_ego](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/bev_ego.png)

![bev_seg](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/bev_seg.png)


- **轨迹预测**

![1_6191](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/1_6191.png)

- **深度估计**

![stereonet_disparity](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/stereonet_disparity.png)

![stereonet_depth](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/stereonet_depth.png)
...
挂载完数据后，请登录开发板，开发板登录方法，请阅读[**开发板登录**](../../../02_02_02_Quick_start/04_02_02_02_Quick_start/04_remote_login.md) 章节内容，登录成功后，执行 ``centernet_resnet101/`` 目录下的accuracy.sh脚本，如下所示：
...
![hrt_model_exec_help](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/hrt_model_exec_help_x5.png)
...
```
  hrt_model_exec model_info --model_file=xxx.bin --model_name=xx
```
![model_info](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/model_info_x5.png)
...
![infer](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/perf_x5.png)
...
![enable_cls_post_process](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/enable_cls_post_process_x5.png)
...
![perf](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/perf_x5.png)
...
![hrt_bin_dump_help](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/hrt_bin_dump_help_x5.png)
...
![run_log](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/run_log_x5.png)

在路径 **outputs/** 文件夹下可以查看输出，参见以下截图：

![output](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/04_toolchain_development/02_intermediate/output_x5.png)
