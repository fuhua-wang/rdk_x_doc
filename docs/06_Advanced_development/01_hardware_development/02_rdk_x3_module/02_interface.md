...
![image-carrier-board1](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/02_rdk_x3_module/image/rdk_x3_module/image-carrier-board1.png) 
...
![image-x3-md-setup](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/06_06_06_Advanced_development/01_hardware_development/02_rdk_x3_module/image/rdk_x3_module/image-x3-md-setup.png) 
...
上述Camera模组的购买方式可参考[购买链接](05_01_02_02_Quick_start/08_accessory.md)。
...
对于MIPI DSI接口的详细使用方法，可参考[MIPI DSI显示屏使用](04_display.md)。
