...
3. 点击安装 Performance Node 到开发板上。
    ...
    ![下载界面](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/03_03_03_System_configuration/image/cpu_frequency/rdk_studio/performance-node-install.png)

4. Performance Node 性能检测展示：

    - **CPU 性能界面：**

        ![CPU 性能界面](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/03_03_03_System_configuration/image/cpu_frequency/rdk_studio/performance-node-CPU.png)
    ...
    - **BPU/GPU 性能界面：**
        ...
        ![BPU/GPU 性能界面](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/03_03_03_System_configuration/image/cpu_frequency/rdk_studio/performance-node-BPU-GPUpng.png)
    ...
    - **Memory 性能界面：展示已用和可用内存。**
        ...
        ![Memory 性能界面](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/03_03_03_System_configuration/image/cpu_frequency/rdk_studio/performance-node-memory.png)
    ...
    - **Disk 性能界面：展示已用和可用磁盘。**
        ...
        ![Disk 性能界面](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/03_03_03_System_configuration/image/cpu_frequency/rdk_studio/performance-node-disk.png)
...
5. 性能监测设置：
   ...
   ![设置界面](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/03_03_03_System_configuration/image/cpu_frequency/rdk_studio/performance-node-operation.png)
   ...
   - 界面切换：默认为竖屏界面，点击 `点我前往横屏界面`，可切换为横屏展示。
      ...
      ![横屏界面](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/03_03_03_System_configuration/image/cpu_frequency/rdk_studio/performance-node-row.png)
