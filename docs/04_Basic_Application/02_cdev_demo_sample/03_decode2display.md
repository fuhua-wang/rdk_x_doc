...
![output-img](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_cdev_demo_sample/image/cdev_decode2dsiplay_output.png)
...
![HDMI_IMG](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_cdev_demo_sample/image/cdev_decode2display_vlc.png)
...
<center>
![software_arch](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_cdev_demo_sample/image/cdev_decode2display_software_arch.png)
</center>

### API 流程说明
<center>
![API_Flow](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_cdev_demo_sample/image/cdev_decode2display_api_flow.png)
</center>

### 07_07_FAQ
__Q：__ API 有更详细的说明吗？\
__A：__ 可以到 [解码模块 API](../06_multi_media_sp_dev_api/RDK_X5/cdev_multimedia_api_x5/03_decoder_api.md) 位置进行查询。
