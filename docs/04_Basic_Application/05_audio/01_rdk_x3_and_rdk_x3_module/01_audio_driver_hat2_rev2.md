...
1. 按照下图方式，将转接板接入 RDK X3 的 40pin header。
![image-x3md-v2](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-x3md-v2.png)
...
![image-audio-driver-hat-config00](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-audio-driver-hat-config00.png)
