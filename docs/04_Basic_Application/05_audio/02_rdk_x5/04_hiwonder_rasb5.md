...
![image-audio-codec-select-hiwonder-hat-rdkx5.png](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-audio-codec-select-hiwonder-hat-rdkx5.png)
...
```
通过上述查询，结合[板载 Earphone 音频口](01_in_board_es8326.md#运行)的介绍，可以确认，声卡0对应的是 `Hiwonder Audio Driver HAT` 节点；设备也是存在的, 且设备号为 `0-0` 和 `0-1` , 实际我们操作的设备应该是`pcmC0D0p 和 pcmC0D1c`。
...
## 常见问题
[可以跳转到FQA部分查看](../../../08_07_07_FAQ/04_multimedia.md#audio-常见问题)