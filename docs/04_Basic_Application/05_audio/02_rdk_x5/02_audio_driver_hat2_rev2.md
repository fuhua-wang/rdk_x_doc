...
![image-audio-driver-hat](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-audio-driver-hat.jpg)
...
![image-audio-driver-hat-setup](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-audio-driver-hat-setup.jpg)
...
![image-audio-codec-select-hat-v2-rdkx5.png](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-audio-codec-select-hat-v2-rdkx5.png)
...
```
通过上述查询，结合[板载 Earphone 音频口](01_in_board_es8326.md#运行)的介绍，可以确认，声卡0对应的是 `Audio Driver HAT REV2` 节点；设备也是存在的, 且设备号为 `0-0` 和 `0-1` , 实际我们操作的设备应该是`pcmC0D0p 和 pcmC0D1c`。
...
如遇其他问题，可参考[音频常见问题](../../../08_07_07_FAQ/04_multimedia.md#audio-常见问题)获取更多帮助。