...
![image-audio-wm8960](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-audio-wm8960.jpg)
...
![image-wm8960-audio-hat-rkd-x5-setup-2](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-wm8960-audio-hat-rkd-x5-setup-2.png)
...
![image-audio-codec-select-wm8960-hat-rdkx5](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/02_audio/image/image-audio-codec-select-wm8960-hat-rdkx5.png)  
...
```
通过上述查询，结合[板载 Earphone 音频口](01_in_board_es8326.md#运行)的介绍，可以确认，声卡0对应的是 `WM8960 Audio Driver HAT` 节点；设备也是存在的, 且设备号为 `0-0` 和 `0-1` , 实际我们操作的设备应该是`pcmC0D0p 和 pcmC0D1c`。
