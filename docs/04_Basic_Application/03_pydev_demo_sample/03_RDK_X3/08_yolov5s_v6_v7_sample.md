...
## 效果展示
![output-img](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/03_pydev_demo_sample/image/pydev_12_runing_v6.png)

## 硬件准备

### 硬件连接
该示例只需要 RDK 开发板本身，无需额外的外设连接。确保开发板正常供电并启动系统。
![connect-img](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/03_pydev_demo_sample/image/pydev_12_hw_connect.png)
...
<center>
![software_arch](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/03_pydev_demo_sample/image/pydev_12_yolov5s_v6_v7_sample_software_arch.png)
</center>
...
<center>
![API_Flow](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/04_04_04_Basic_Application/03_pydev_demo_sample/image/pydev_12_yolov5s_v6_v7_sample_api_flow.png)
</center>
